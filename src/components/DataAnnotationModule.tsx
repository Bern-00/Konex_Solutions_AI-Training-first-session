                    ...
                    <div className="animate-in scale-95 duration-700">
                        {responses.exam.status === 'submitted' ? (
                            ...
                            <div className="space-y-12">
                                ...
                                <div className="space-y-6">
                                    <div className="bg-neon/5 border border-neon/10 p-4">
                                        <details className="group">
                                            <summary className="text-[10px] font-black uppercase cursor-pointer list-none flex items-center justify-between text-neon/60 hover:text-neon transition-colors">
                                                <span>[ LIRE_LE_TEXTE_DE_RÉFÉRENCE ]</span>
